      ...
      <section class="section">
        <div class="main-container">
          ...
          <div class="cta-container">
            <div class="cta-title">Você é Cabeleireiro(a) Profissional?</div>
            ...
            <a
              ...
              class="cta-button"
              title="Cadastre-se como Cabeleireiro(a) Profissional"
          ...
          <form action="form.php" method="POST">
            ...
            <div id="step-1" class="section-container form-container active">
              ...
              <h2>Qual tipo de serviço de cabeleireiro você procura?</h2>
            ...
            <div id="step-2" class="section-container form-container">
              ...
              <h2>Qual o estilo desejado para o serviço?</h2>
              <div class="service-list">
                <label
                  ><input
                    type="radio"
