...
<head>
  ...
  <style>
    ...
    .section-container {
      ...
      position: relative;
      /* Permite o posicionamento relativo dos elementos internos */
      padding: 20px;
      /* Espaçamento interno */
    ...
    .progress-bar {
      position: relative;
      /* Permite o posicionamento relativo da barra de progresso interna */
      height: 10px;
    ...
    .progress {
      height: 100%;
      /* Altura total da barra de progresso */
      width: 0;
      /* Largura inicial da parte preenchida (ajustada dinamicamente) */
      background: #ff66c4;
      /* Cor de fundo da parte preenchida */
      border-radius: 5px;
      /* Bordas arredondadas */
      transition: width 0.3s ease;
      /* Transição suave para a mudança de largura */
    }
    ...
    .form-container .buttons {
      ...
      display: flex;
      /* Utiliza Flexbox para layout dos botões */
    }
    ...
    .form-container .buttons button {
      ...
      /* Bordas arredondadas */
      cursor: pointer;
      /* Cursor em forma de mão para indicar clicável */
      margin-right: 10px;
      /* Espaçamento à direita entre os botões */
    }
    ...
    <section class="section">
      <div class="main-container">
        ...
        <div class="cta-container">
          <div class="cta-title">Você é Profissional de Depilação?</div>
          <div class="cta-subtitle">
            A Swan Shine recebe mais de 2 mil pedidos por mês e pode ajudar a
            aumentar sua renda
          </div>
          <a href="../../../../forms/form_profissional/form_profissional.html" class="cta-button" title="Cadastre-se como Profissional de Depilação">Quero me cadastrar</a>
        </div>
        ...
        <form action="form.php" method="POST">
          ...
          <div id="step-1" class="section-container form-container active">
            ...
            <h2>Qual tipo de depilação você procura?</h2>
            <div class="service-list">
              <label><input type="checkbox" name="tipo" value="Depilação a Laser" required />
                Depilação a Laser</label>
              <label><input type="checkbox" name="tipo" value="Depilação com Cera" required />
                Depilação com Cera</label>
              <label><input type="checkbox" name="tipo" value="Depilação com Linha" required />
                Depilação com Linha</label>
              <label><input type="checkbox" name="tipo" value="Depilação com Creme" required />
                Depilação com Creme</label>
              <label><input type="checkbox" name="tipo" value="Depilação Íntima" required />
                Depilação Íntima</label>
              <label><input type="checkbox" name="tipo" value="Outro" required />
                Outro</label>
            </div>
            <div class="buttons">
          ...
          <div id="step-2" class="section-container form-container">
            ...
            <h2>Qual o estilo desejado para a depilação?</h2>
            <div class="service-list">
              <label><input type="radio" name="estilo" value="Simples" required />
                Simples</label>
              <label><input type="radio" name="estilo" value="Com Design" required />
                Com Design</label>
              <label><input type="radio" name="estilo" value="Com Hidratante" required />
                Com Hidratante</label>
              <label><input type="radio" name="estilo" value="Outra" required />
                Outra</label>
            </div>
            <div class="buttons">
