    ...
    <section class="section">
      <div class="main-container">
        ...
        <div class="cta-container">
          <div class="cta-title">Você é Maquiador(a) Profissional?</div>
          ...
          <a
            ...
            class="cta-button"
            title="Cadastre-se como Maquiador(a) Profissional">Quero me cadastrar</a>
        </div>
        ...
        <form action="form.php" method="POST">
          ...
          <div id="step-1" class="section-container form-container active">
            ...
            <h2>Qual tipo de serviço de maquiagem você procura?</h2>
            <div class="service-list">
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem para Eventos"
                  required />
                Maquiagem para Eventos</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem para Noivas"
                  required />
                Maquiagem para Noivas</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem Social"
                  required />
                Maquiagem Social</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem Artística"
                  required />
                Maquiagem Artística</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem para Fotos"
                  required />
                Maquiagem para Fotos</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Maquiagem para Filmes"
                  required />
                Maquiagem para Filmes</label>
              <label><input
                  type="checkbox"
                  name="tipo"
                  value="Outro"
          ...
          <div id="step-2" class="section-container form-container">
            ...
            <h2>Qual o estilo desejado para a maquiagem?</h2>
            <div class="service-list">
              <label><input
                  type="radio"
                  name="estilo"
