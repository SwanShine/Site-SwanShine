      ...
      <section class="section">
        <div class="main-container">
          ...
          <div class="cta-container">
            <div class="cta-title">Você é Trancista Profissional?</div>
            ...
            <a
              ...
              class="cta-button"
              title="Cadastre-se como Trancista Profissional"
          ...
          <form action="form.php" method="POST">
            ...
            <div id="step-1" class="section-container form-container active">
              ...
              <h2>Qual tipo de serviço de tranças você procura?</h2>
              <div class="service-list">
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tranças Box Braids"
                    required
                  />
                  Tranças Box Braids</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tranças Box Braids com Cabelo Sintético"
                    required
                  />
                  Tranças Box Braids com Cabelo Sintético</label
                >
                <label
                  ><input
                    type="checkbox"
                ...
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tranças Senegalese"
                    required
                  />
                  Tranças Senegalese</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tranças de Origem Brasileira"
                    required
                  />
                  Tranças de Origem Brasileira</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tranças com Acessórios"
                    required
                  />
                  Tranças com Acessórios</label
                >
                <label
                  ><input
                    type="checkbox"
            ...
            <div id="step-2" class="section-container form-container">
              ...
              <h2>Qual o estilo desejado para as tranças?</h2>
              <div class="service-list">
                <label
                  ><input
                    type="radio"
                ...
                <label
                  ><input
                    type="radio"
                    name="estilo"
                    value="Com Acessórios"
                    required
                  />
                  Com Acessórios</label
                >
                <label
                  ><input
                    type="radio"
                ...
                <label
                  ><input
                    type="radio"
                    name="estilo"
                    value="Com Cabelo Sintético"
                    required
                  />
                  Com Cabelo Sintético</label
                >
                <label
                  ><input
                    type="radio"
