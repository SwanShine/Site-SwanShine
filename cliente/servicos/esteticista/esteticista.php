      ...
      <section class="section">
        <div class="main-container">
          ...
          <div class="cta-container">
            <div class="cta-title">Você é Esteticista Profissional?</div>
            ...
            <a
              ...
              class="cta-button"
              title="Cadastre-se como Esteticista Profissional"
          ...
          <form action="form.php" method="POST">
            ...
            <div id="step-1" class="section-container form-container active">
              ...
              <h2>Qual tipo de serviço estético você procura?</h2>
              <div class="service-list">
                <label
                  ><input
                    ...
                    required
                  />
                  Limpeza de Pele</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Hidratação Facial"
                    required
                  />
                  Hidratação Facial</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Peeling Químico"
                    required
                  />
                  Peeling Químico</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Depilação Facial"
                    required
                  />
                  Depilação Facial</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Tratamento Anti-idade"
                    required
                  />
                  Tratamento Anti-idade</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Microagulhamento"
                    required
                  />
                  Microagulhamento</label
                >
                <label
                  ><input
                    type="checkbox"
            ...
            <div id="step-2" class="section-container form-container">
              ...
              <h2>Qual o objetivo do seu tratamento estético?</h2>
              <div class="service-list">
                <label
                  ><input
                    type="radio"
                    ...
                    required
                  />
                  Rejuvenescimento</label
                >
                <label
                  ><input
                    type="radio"
                    name="estilo"
                    value="Hidratação Profunda"
                    required
                  />
                  Hidratação Profunda</label
                >
                <label
                  ><input
                    type="radio"
                ...
                <label
                  ><input
                    type="radio"
                    name="estilo"
                    value="Redução de Linhas"
                    required
                  />
                  Redução de Linhas</label
                >
                <label
                  ><input
                    type="radio"
