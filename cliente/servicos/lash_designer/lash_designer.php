      ...
      <section class="section">
        <div class="main-container">
          ...
          <div class="cta-container">
            <div class="cta-title">Você é Designer de Cílios Profissional?</div>
            ...
            <a
              ...
              class="cta-button"
              title="Cadastre-se como Designer de Cílios Profissional"
          ...
          <form action="form.php" method="POST">
            ...
            <div id="step-1" class="section-container form-container active">
              ...
              <h2>Qual tipo de serviço de extensão de cílios você procura?</h2>
              <div class="service-list">
                ...
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Cílios de Seda"
                    required
                  />
                  Cílios de Seda</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Cílios Fio a Fio"
                    required
                  />
                  Cílios Fio a Fio</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Cílios Híbridos"
                    required
                  />
                  Cílios Híbridos</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Cílios Mega Volume"
                    required
                  />
                  Cílios Mega Volume</label
                >
                <label
                  ><input
                    type="checkbox"
                    name="tipo"
                    value="Cílios de Mink"
                    required
                  />
                  Cílios de Mink</label
                >
                <label
                  ><input
                    type="checkbox"
            ...
            <div id="step-2" class="section-container form-container">
              ...
              <h2>Qual o estilo desejado para as extensões de cílios?</h2>
              <div class="service-list">
                <label
                  ><input
                    type="radio"
