        ...
        <section class="section">
            <div class="main-container">
                ...
                <div class="cta-container">
                    <div class="cta-title">Você é Barbeiro Profissional?</div>
                    <div class="cta-subtitle">
                    A Swan Shine recebe mais de 2 mil pedidos por mês e pode ajudar a
                    aumentar sua renda
                    </div>
                    <a href="../../../home/forms/form_profissional/form_profissional.html" class="cta-button"title="Cadastre-se como Barbeiro Profissional"> Quero me cadastrar</a>
                </div>
                ...
                <form action="form.php" method="POST">
                        ...
                        <div id="step-2" class="section-container form-container">
                            <div class="progress-bar">
                                <div class="progress" id="progress-bar-2"></div>
                            </div>
                        
                            <h2>Qual o estilo desejado para o corte de cabelo?</h2>
                            <div class="service-list">
                                <label>
                                    <input type="radio" name="estilo" value="Clássico" required />
                                    Clássico
                                </label>
                                <label>
                                    <input type="radio" name="estilo" value="Moderno" required />
                                    Moderno
                                </label>
                                <label>
                                    <input type="radio" name="estilo" value="Desconectado" required />
                                    Desconectado
                                </label>
                                <label>
                                    <input type="radio" name="estilo" value="Fade" required />
                                    Fade
                                </label>
                                <label>
                                    <input type="radio" name="estilo" value="Com Franja" required />
                                    Com Franja
                                </label>
                                <label>
                                    <input type="radio" name="estilo" value="Outro" required />
                                    Outro
                                </label>
                            </div>
                            <div class="buttons">
