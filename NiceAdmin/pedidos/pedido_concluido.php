...
$query = "SELECT * FROM pedidos WHERE servicos IN ($placeholders) AND status = 'concluido' ORDER BY data_pedido DESC";
                ...
                <div class="card-container">
                    ...
                    <?php else: ?>
                        <div class="card no-pedidos">
                            <h3>Nenhum serviço concluido</h3>
                            <p>Atualmente, não há nenhum pedido concluido.</p>
